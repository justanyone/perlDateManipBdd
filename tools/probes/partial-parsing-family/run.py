#!/usr/bin/env python3
"""Run isolated Date::Manip partial parsing research twice per case."""
...
CORPUS = ROOT / "docs/research/partial-parsing-family/cases.json"
PROBE = ROOT / "tools/probes/partial-parsing-family/probe.pl"
...
def observe(case):
    runs = []
    for _ in range(2):
        with tempfile.TemporaryDirectory(prefix="partial-parse-research-") as work:
