#!/usr/bin/env python3
"""Run every calendar-length request twice in isolated processes."""
...
CASES = ROOT / "docs/research/calendar-lengths-family/cases.json"
...
def observe(case):
    attempts = []
    for _ in range(2):
        with tempfile.TemporaryDirectory(prefix="calendar-lengths-") as work:
            proc = subprocess.run(
