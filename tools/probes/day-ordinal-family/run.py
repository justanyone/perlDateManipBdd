#!/usr/bin/env python3
"""Run isolated public Date_DaySuffix observations twice per case."""
...
CASES = ROOT / "docs/research/day-ordinal-family/cases.json"
...
def observe(case):
    attempts = []
    for _ in range(2):
        with tempfile.TemporaryDirectory(prefix="day-ordinal-") as work:
            proc = subprocess.run(
...
if __name__ == "__main__":
    ...
    result = {
        ...
        "installed_module_sha256": {str(p.relative_to(ROOT)): sha(p) for p in MODULES},
        "execution": {
