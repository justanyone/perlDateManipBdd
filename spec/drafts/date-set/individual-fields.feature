...
Feature: Replacing one civil or clock field
  ...
  Scenario: Each documented field can be replaced, including zero clock fields
    ...
    And every scalar is defined, every list has the six exact fields shown, and local equals GMT
    And the exact results are:
      | case | initial receiver | exact request | field | replacement | wall result | fields | GMT result |
  ...
  Scenario: Field names are accepted without regard to letter case
    ...
    And the GMT result is "2040-02-01 22:05:09"
  ...
  Scenario: An explicit daylight request selects either side of an overlap
    ...
    Then every status is 0 and every error is empty
    And the exact results are:
      | case | initial receiver | exact request | daylight request | wall result | GMT result |
  ...
  Scenario: Omitting the daylight request on a partial change retains the daylight side
    ...
    And the GMT result is "2024-11-03 05:30:00"
  ...
  Scenario: Individual replacements accept malformed or out-of-range field values
    Given independent valid receivers
    When I replace one field with each value below
    Then every call returns status 0 with every call and observer error empty and no exception
    And the raw native scalar and six returned fields remain exactly as shown
    And the GMT observer returns the shown six-field presentation even when either presentation is not a valid civil date
    And the exact binding observations are:
      | case | initial receiver | exact request | field and value | native scalar | returned fields | GMT result | warning count |
      | DSET-FIELD-008-MONTH-ZERO | valid "2040-02-29 16:05:09 America/Chicago" | selector text "m"; arguments [number 0] | month 0 | 2040002916:05:09 | 2040, 0, 29, 16, 5, 9 | 2040-00-29 22:05:09 | 0 |
      | DSET-FIELD-009-DAY-ZERO | valid "2040-02-29 16:05:09 America/Chicago" | selector text "d"; arguments [number 0] | day 0 | 2040020016:05:09 | 2040, 2, 0, 16, 5, 9 | 2040-01-31 22:05:09 | 0 |
      | DSET-FIELD-010-MONTH-13 | valid "2040-02-29 16:05:09 America/Chicago" | selector text "m"; arguments [number 13] | month 13 | 2040132916:05:09 | 2040, 13, 29, 16, 5, 9 | 2040-13-29 22:05:09 | 0 |
      | DSET-FIELD-011-DAY-31-COMPAT | valid "2040-02-29 16:05:09 America/Chicago" | selector text "d"; arguments [number 31] | day 31 in February | 2040023116:05:09 | 2040, 2, 31, 16, 5, 9 | 2040-03-02 22:05:09 | 0 |
      | DSET-FIELD-012-DAY-32 | valid "2040-02-29 16:05:09 America/Chicago" | selector text "d"; arguments [number 32] | day 32 | 2040023216:05:09 | 2040, 2, 32, 16, 5, 9 | 2040-03-03 22:05:09 | 0 |
      | DSET-FIELD-013-HOUR-24 | valid "2040-02-29 16:05:09 America/Chicago" | selector text "h"; arguments [number 24] | hour 24 with nonzero minutes | 2040022924:05:09 | 2040, 2, 29, 24, 5, 9 | 2040-03-01 06:05:09 | 0 |
      | DSET-FIELD-014-MINUTE-60 | valid "2040-02-29 16:05:09 America/Chicago" | selector text "mn"; arguments [number 60] | minute 60 | 2040022916:60:09 | 2040, 2, 29, 16, 60, 9 | 2040-02-29 23:00:09 | 0 |
      | DSET-FIELD-015-SECOND-60 | valid "2040-02-29 16:05:09 America/Chicago" | selector text "s"; arguments [number 60] | second 60 | 2040022916:05:60 | 2040, 2, 29, 16, 5, 60 | 2040-02-29 22:06:00 | 0 |
      | DSET-FIELD-016-NONNUMERIC | valid "2040-02-29 16:05:09 America/Chicago" | selector text "d"; arguments [text "nope"] | day text nope | 204002nope16:05:09 | 2040, 2, nope, 16, 5, 9 | 2040-01-31 22:05:09 | 2 |
      | DSET-FIELD-017-UNDEFINED | valid "2040-02-29 16:05:09 America/Chicago" | selector text "d"; arguments [undefined] | undefined day | 20400216:05:09 | 2040, 2, undefined, 16, 5, 9 | 2040-01-31 22:05:09 | 10 |
      | DSET-FIELD-033-ISDST-TWO | valid "2040-02-29 16:05:09 America/New_York" | selector text "d"; arguments [number 1, number 2] | day 1 and daylight value 2 | 2040020116:05:09 | 2040, 2, 1, 16, 5, 9 | 2040-02-01 21:05:09 | 0 |
      | DSET-FIELD-034-NEGATIVE-DAY | valid "2040-02-29 16:05:09 America/New_York" | selector text "d"; arguments [number -1] | day -1 | 204002-116:05:09 | 2040, 2, -1, 16, 5, 9 | 2040-01-30 21:05:09 | 0 |
    And the warning channels are empty except for the exact nonnumeric and undefined cases
  ...
  @reference-binding @excluded-from-portable-handoff @DSET-BIND-FIELD-WARNINGS
  Scenario: Perl reports binding warnings for year zero and an omitted selector
    ...
    Then the year-zero call warns once for each undefined timezone-period bound
